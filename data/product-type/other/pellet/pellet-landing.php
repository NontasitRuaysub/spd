...
<body>
    ...
    <main>
        ...
        <div id="icon">
            <div class="container">
                <div class="content">
                    <img src="../imgs/other-logo.png" alt="สินค้าสัตว์อื่นๆ" title="สินค้าสัตว์อื่นๆ">
                    <h1 class="is-size-2-mobile is-size-1-tablet">สินค้าสัตว์อื่นๆ</h1>
                </div>
            </div>
        </div>

        <!-- Pellet -->
        <section class="section other-pd">
            <div class="container">
                <div class="content">
