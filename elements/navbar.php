<nav id="header-navbar" class="FFF8EE">
    ...
    <div class="navbar-cs-menu">
        <ul>
                                    ...
                                    <li class="food-product dog-food"><a href="#">อาหาร<span class="arrow">&#62;</span></a>
                                        <div class="third-dropdown FFF8EE dog-food-list">
                                            <ul>
                                                ...
                                                <li><a href="data/product-type/dog/pellet/pellet-landing.php">อาหารเม็ด</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li><a href="data/product-type/dog/sweet/sweet-landing.php">ขนม</a></li>
                                    <li><a href="data/product-type/dog/tools/tools-landing.php">ของใช้</a></li>
                                    <li><a href="data/product-type/dog/toys/toy-landing.php">ของเล่น</a></li>
                                </ul>
                            </div>
                        </li>
                                    ...
                                    <li class="food-product other-food"><a href="#">อาหาร<span class="arrow">&#62;</span></a>
                                        <div class="third-dropdown FFF8EE other-food-list">
                                            <ul>
                                                ...
                                                <li><a href="data/product-type/other/pellet/pellet-landing.php">อาหารเม็ด</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li><a href="data/product-type/other/sweet/sweet-landing.php">ขนม</a></li>
                                    <li><a href="data/product-type/other/tools/tools-landing.php">ของใช้</a></li>
                                    <li><a href="data/product-type/other/toys/toy-landing.php">ของเล่น</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
            ...
            <li><a href="q-a.php">คำถามที่พบบ่อย</a></li>
            <li><a href="data/articles/article-index.php">บทความ</a></li>
